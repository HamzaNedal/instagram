...
<div class="container  p-5 ">
     ...
     <form class="form-horizontal" action="{{ url('admin/edit/'.$user->id) }}" method="Post" enctype="multipart/form-data">@csrf
        @method('PUT')
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control {{$errors->has('username')?' is-invalid ' : ''}} " name="username" id="username" placeholder="Username Here" value="{{$user->username}}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control {{$errors->has('name')?' is-invalid ' : ''}}" name="name" id="name" placeholder=" Name Here" value="{{$user->name}}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="email" class="form-control {{$errors->has('email')? 'is-invalid' : ''}}" name="email" id="email1" placeholder="Email Here" value="{{$user->email}}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control {{$errors->has('website')? 'is-invalid' : ''}}"  name="website" id="cono1" placeholder="Website Here" value="{{$user->website}}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control  {{$errors->has('subject')? 'is-invalid' : ''}}" name="subject" style="margin-top: 0px; margin-bottom: 0px; height: 56px;">{{$user->subject}}</textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <select class="select2 form-control custom-select select2-hidden-accessible" name='gender'style="width: 100%; height:36px;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                            ...
                            <option value="None" {{($user->Gender == 'None') ? 'selected' : ''}}>Choose...</option>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <div class="custom-file">
                            <input type="file" class="custom-file-input  {{$errors->has('image')? 'is-invalid' : ''}}" id="validatedCustomFile"  name="photo">
